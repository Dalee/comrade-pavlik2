...
func TestUnmarshalProjectV4(t *testing.T) {
	project := Project{}

	data := getTestRawDataFromFile(t, "./test-data/project/item_v4.json")
...
func TestUnmarshalTagV4(t *testing.T) {
	tag := Tag{}

	data := getTestRawDataFromFile(t, "./test-data/tag/item_v4.json")
